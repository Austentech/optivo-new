...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      { title: "Careers — Join Optivo Solutions" },
      { name: "description", content: "Build a career at one of India's fastest-growing digital marketing agencies. Open roles, perks and culture." },
